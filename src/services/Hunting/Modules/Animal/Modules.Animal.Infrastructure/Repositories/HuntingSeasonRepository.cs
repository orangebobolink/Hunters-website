...
namespace Modules.Animal.Infrastructure.Repositories
{
    ...
    {
        public override async Task<List<HuntingSeason>> GetAllAsync(
        ...
        public override async Task<HuntingSeason?> GetByIdAsync(
            Guid id, 
            CancellationToken cancellationToken)
        {
            return await _context.HuntingSeasons
        ...
        public async Task<List<HuntingSeason>> GetHuntingSeasonsByTimePeriod(
            DateTime startDate, 
            DateTime endDate, 
            CancellationToken cancellationToken)
        {
        ...
        public async Task<HuntingSeason?> GetHuntingSeasonByTimePeriodForAnimal(
            Guid animalId, 
            DateTime startDate, 
            DateTime endDate,
            CancellationToken cancellationToken)
        {
            return await _context.HuntingSeasons
                .AsNoTracking()
                .FirstOrDefaultAsync(hs => hs.AnimalId == animalId
