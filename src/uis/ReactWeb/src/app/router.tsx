...
import ProfilePage from '@/pages/ui/profile/ui/page';
import MyTripsPage from '@/pages/ui/profile/ui/myTripPage';
import RentPage from '@/pages/ui/rent/page.tsx';
import ReportPage from '@/pages/ui/report/page.tsx';
import ProfileInformationPage from '@/pages/ui/profile/ui/profileInformationPage';
import SettingPage from '@/pages/ui/profile/ui/settingPage';
            ...
            <Routes location={background || location}>
                <Route path={RoutesMap.home} element={<HomePage />}>
                    ...
                    {roles.includes('Admin') && (
                        <>
                            <Route
                                path={RoutesMap.managing}
                                element={<ManagingPage />}
                            />
                            <Route
                                path={RoutesMap.rent}
                                element={<RentPage />}
                    ...
                    {roles.includes('User') && (
                        <>
                            <Route
                                path={RoutesMap.paymantFee}
                                element={<PaymantPage />}
                            />
                            <Route
                                path={RoutesMap.checkHuntingLicense}
                                element={<HuntingLicensePage />}
                            />
                            <Route
                                path={RoutesMap.rent}
                                element={<RentPage />}
                    ...
                    {(roles.includes('Manager') ||
                        ...
                        <>
                            <Route
                                path={RoutesMap.feeding}
                                element={<FeedingPage />}
                            />
                            <Route
                                path={RoutesMap.permission}
                    ...
                    <Route path={RoutesMap.profile} element={<ProfilePage />}>
                        <Route
                            path={RoutesMap.myTrips}
                            element={<MyTripsPage />}
                        />
                        <Route
                            path={RoutesMap.inform}
