...
const ProductRevenueBar = () => {
    const [productsPopular, setProductsPopular] = useState<ProductPeriodRevenue[]>([]);
    ...
    useEffect(() => {
        const fetchPermissions = async () => {
            try {
                const response = await ReportService.getProductsRevenueByPeriod(period);
